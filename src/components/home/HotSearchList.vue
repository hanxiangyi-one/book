<template>
  <transition name="hot-search-move">
    <scroll class="hot-search-wrapper" :top="52" @onScroll="onScroll" ref="scroll">
      <hot-serch :label="$t('home.hotSearch')"
                 :btn="$t('home.change')"
                 :hotSearch="searchList.hotSearch"></hot-serch>
      <div class="line"></div>
      <hot-serch :label="$t('home.historySearch')"
                 :btn="$t('home.clear')"
                 :hotSearch="searchList.historySearch"></hot-serch>
    </scroll>
  </transition>
</template>
